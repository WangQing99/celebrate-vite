...
async function handleLogin() {
  try {
    ...
    createErrorModal({
      title: "错误提示",
      content:
        (error as unknown as Error).message || "网络异常，请检查您的网络连接是否正常!"
    });
  } finally {
    loading.value = false;
  }
  ...
  <div class="flex min-h-screen items-center justify-center">
    <div class="min-h-1/2 bg-gray-900 border border-gray-900 rounded-2xl">
      ...
      >
        ...
        <input
          @click="handleLogin"
          class="w-full p-2 bg-gray-50 rounded-full font-bold text-gray-900 border border-gray-700 cursor-pointer"
          type="submit"
          name="correo"
        />
        <p>
