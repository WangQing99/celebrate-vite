...
const { account,password } = toRefs(formData);
</script>
  ...
  <div class="flex min-h-screen items-center justify-center">
        <div class="min-h-1/2 bg-gray-900  border border-gray-900 rounded-2xl">
            <div class="mx-4 sm:mx-24 md:mx-34 lg:mx-56 mx-auto  flex items-center space-y-4 py-16 font-semibold text-gray-500 flex-col">
                ...
                <input v-model="account" class="w-full p-2 bg-gray-900 rounded-md  border border-gray-700 focus:border-blue-700"
                    placeholder="Correo" type="email" name="correo">
                <input v-model="password" class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 " placeholder="password*"
                    type="password" name="correo">
                <input @click="handleLogin" class="w-full p-2 bg-gray-50 rounded-full font-bold text-gray-900 border border-gray-700 "
